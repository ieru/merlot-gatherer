CREATE DATABASE  IF NOT EXISTS `dbcrawlermerlot` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dbcrawlermerlot`;
...
) ENGINE=InnoDB AUTO_INCREMENT=10688 DEFAULT CHARSET=utf8 COMMENT='InnoDB free: 32768 kB';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `loauthors`
--

LOCK TABLES `loauthors` WRITE;
/*!40000 ALTER TABLE `loauthors` DISABLE KEYS */;
/*!40000 ALTER TABLE `loauthors` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=31779 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `locat_dat`
--

LOCK TABLES `locat_dat` WRITE;
/*!40000 ALTER TABLE `locat_dat` DISABLE KEYS */;
/*!40000 ALTER TABLE `locat_dat` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `locategories`
--

LOCK TABLES `locategories` WRITE;
/*!40000 ALTER TABLE `locategories` DISABLE KEYS */;
/*!40000 ALTER TABLE `locategories` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `locomments`
--

LOCK TABLES `locomments` WRITE;
/*!40000 ALTER TABLE `locomments` DISABLE KEYS */;
/*!40000 ALTER TABLE `locomments` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `lodata`
--

LOCK TABLES `lodata` WRITE;
/*!40000 ALTER TABLE `lodata` DISABLE KEYS */;
/*!40000 ALTER TABLE `lodata` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `loorganizations`
--

LOCK TABLES `loorganizations` WRITE;
/*!40000 ALTER TABLE `loorganizations` DISABLE KEYS */;
/*!40000 ALTER TABLE `loorganizations` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `loreviews`
--

LOCK TABLES `loreviews` WRITE;
/*!40000 ALTER TABLE `loreviews` DISABLE KEYS */;
/*!40000 ALTER TABLE `loreviews` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=6184 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `loval_com`
--

LOCK TABLES `loval_com` WRITE;
/*!40000 ALTER TABLE `loval_com` DISABLE KEYS */;
/*!40000 ALTER TABLE `loval_com` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `loval_rev`
--

LOCK TABLES `loval_rev` WRITE;
/*!40000 ALTER TABLE `loval_rev` DISABLE KEYS */;
/*!40000 ALTER TABLE `loval_rev` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `lovaloration`
--

LOCK TABLES `lovaloration` WRITE;
/*!40000 ALTER TABLE `lovaloration` DISABLE KEYS */;
/*!40000 ALTER TABLE `lovaloration` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `users_lo`
--

LOCK TABLES `users_lo` WRITE;
/*!40000 ALTER TABLE `users_lo` DISABLE KEYS */;
/*!40000 ALTER TABLE `users_lo` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-04-01 15:06:48
